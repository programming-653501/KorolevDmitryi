...
{
	Form2->Edit1->Text="Фирма";
	Form2->Edit2->Text="Город";
	Form2->Edit3->Text="Должность";
	Form2->Edit4->Text="Специальность";
	Form2->Edit5->Text="Возраст";
	Form2->Edit6->Text="Зарплата";
