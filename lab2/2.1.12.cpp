...
{   float x[3],y[3],z[3];
	...
	case 2:if(s[0]==0||s[1]==0||s[2]==0){
		   ...
		   type(s);
		   break;
	case 4:if(s[0]==0||s[1]==0||s[2]==0){
		   std::cout<<"Error.";
		   break;
		   }
		   std::cout<<"Square of your triangle is "<<square(s);
		   break;
	case 3:if(s[0]==0||s[1]==0||s[2]==0){
		   std::cout<<"Error.";
		   break;
		   }
		   std::cout<<"Perimeter of your triangle is "<<perimeter(s);
		   break;
	case 5:if(s[0]==0||s[1]==0||s[2]==0){
		   std::cout<<"Error.";
		   break;
		   }
		   circles(s);
		   break;
	case 6:std::cout<<"\"Everything u wanted to know about triangles\". v 1.0.5 by Korolev Dima";
		   break;
	case 7:return 0;
